  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    strankaIzRacuna(polja.seznamRacunov, function(napaka1, stranka) {
      pesmiIzRacuna(polja.seznamRacunov, function(napaka2, pesmi) {
        if (!pesmi || !stranka || napaka1 || napaka2) {
          odgovor.sendStatus(500);
        } else {
...
streznik.get('/izpisiRacun/:oblika', function(zahteva, odgovor) {
  pesmiIzKosarice(zahteva, function(pesmi) {
    if (!pesmi) {
      ...
      strankaIzID(zahteva.session.strankaID, function(napaka, stranka) {
        if(!stranka || napaka) {
          odgovor.sendStatus(500);
        } else {
          odgovor.setHeader('content-type', 'text/xml');
...
streznik.post('/prijava', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    if(napaka1 || napaka2) {
      vrniStranke(function(napaka11, stranke) {
        vrniRacune(function(napaka22, racuni) {
